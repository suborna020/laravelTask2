...
<body class="hold-transition sidebar-mini layout-fixed navbar-lightblue" id="body_css">
    ...
    <div class="wrapper ">
        <nav style="margin-top: -27rem;" class="main-header navbar navbar-expand navbar-lightblue navbar-light">
            ...
            <form class="form-inline ml-3">
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar" type="search" placeholder="Search emails" aria-label="Search" size="110">
        ...
        <aside class=" main-sidebar elevation-4 " style="background-color:#213F7E;">
            ...
            <div id="center">
                <a class="btn btn-info" href="javascript:;" data-toggle="modal" data-target="#composeModal" style="border-radius:0px !important;">
                    Compose
                </a>
            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <input type="text" required="required" name="question" placeholder="From :   demo@mail.com" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <input type="text" required="required" name="question" placeholder="To :   demo@mail.com" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <input type="text" required="required" name="question" placeholder="Subject" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">

                                                            <textarea id="composeTextarea" class="form-control" rows="3" placeholder=" Details"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
